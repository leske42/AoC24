...
/*   Updated: 2024/12/16 20:27:23 by mhuszar          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
typedef std::pair<size_t /*cost of route*/, Player> Route;
Route old_route;
typedef std::multimap<size_t, Player> Routes;
Routes routes;
...
int main(int ac, char** av)
{
    ...
    std::cout << old_route.first << std::endl;
}
